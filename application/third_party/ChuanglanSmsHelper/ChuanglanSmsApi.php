...
class ChuanglanSmsApi {
	...
	const API_SEND_URL=CHUANGLAN_API_SEND_URL;
//Interface URL Used to send sendVariableSMS
	...
	const API_ACCOUNT=CHUANGLAN_API_ACCOUNT;//Get SMS Account  from  https://zz.253.com/site/login.html 

	const API_PASSWORD=CHUANGLAN_API_PASSWORD;//Get SMS Password  from https://zz.253.com/site/login.html
	/**
	 * 发送短信
	 *
